...
public class DateUtils {
	...
	public static String formatCurrency(double n, int iteration) {
		...
		return (d < 1000.0)
				? new StringBuilder().append((d > 99.9 || isRound || (!isRound && d > 9.99)) ? Integer.valueOf((int) d * 10 / 10) : new StringBuilder(String.valueOf(d)).toString()).append(c[iteration]).toString()
				: formatCurrency(d, iteration + 1);
	}
	...
	public static String longToDate(long arg) {
	...
	public static String getDate(long arg) {
		Date dt = new Date(arg);
	...
	public static String fromLong(String restingTime, long lenth) {
