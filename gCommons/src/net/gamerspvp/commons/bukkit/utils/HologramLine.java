	...
	private ArmorHologram createEntity(Location location, String text) {
		...
		try {
			...
			if (!location.getWorld().isChunkLoaded(chunkX, chunkZ)) {
				Bukkit.getConsoleSender().sendMessage("§cFalha ao spawnar holograma, chunk nao carregada!");
				return null;
			}
			...
			Bukkit.getConsoleSender().sendMessage("§cFalha ao spawnar holograma: " + e.getMessage());
			return null;
		}
	}
