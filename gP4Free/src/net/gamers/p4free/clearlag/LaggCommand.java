	...
	public boolean execute(CommandSender sender, String arg, String[] args) {
		...
		if (args.length > 0) {
			if (args[0].equalsIgnoreCase("killmobs")) {
				...
				sender.sendMessage("§aVoc§ limpou §f" + cleared + "§a mobs.");
				return true;
			}
			if (args[0].equalsIgnoreCase("unloadchunks")) {
				...
				sender.sendMessage("§aVoc§ limpou §f" + chunks + "§a chunks.");
				return true;
			}
			if (args[0].equalsIgnoreCase("clear")) {
				...
				sender.sendMessage("§aVoc§ limpou §f" + cleared + "§a itens do ch§o.");
				return true;
			}
		}
		sender.sendMessage("");
