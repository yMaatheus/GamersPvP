package dev.gamerspvp.automatictasks.utils;
		...
		if (Titles.packetTitle != null) {
			try {
				...
				Object packet = Titles.packetTitle
						.getConstructor(new Class[] { Titles.packetActions, chatBaseComponent, Integer.TYPE,
	...
	public void updateTitle(Player player) {
		if (Titles.packetTitle != null) {
			try {
				...
				Object packet = Titles.packetTitle
						.getConstructor(new Class[] { Titles.packetActions, chatBaseComponent })
