...
public class GladiadorCommandManager {
	...
	public GladiadorCommandManager(Main instance) {
		...
		Utils.registerCommand(new GladiadorCommand(instance), instance, "gladiador", "glad");
		Utils.registerCommand(new Command("gladiadores") {
	...
	private String getInfoTime(Gladiador gladiador) {
		String time = TimeManager.getTimeEnd(gladiador.getTime());
		statusType status = gladiador.getStatus();
	...
	public void sendHelpCommands(CommandSender sender, String arg) {
		sender.sendMessage("");
		sender.sendMessage("§a[Gladiador] Comandos dispon§veis:");
